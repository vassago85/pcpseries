<section id="season" class="border-b border-white/[0.06] py-16 sm:py-24" aria-labelledby="features-title">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <p class="font-mono text-[10px] uppercase tracking-[0.35em] text-zinc-500">PLENUM Platform</p>
        ...
        <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            @foreach ([
                ['icon' => 'bar-chart', 'title' => 'Track Your Season', 'desc' => 'Points, form and progression across every round.'],
                ['icon' => 'trophy', 'title' => 'View Rankings', 'desc' => 'National standings updated after each match.'],
                ['icon' => 'user', 'title' => 'Shooter Profiles', 'desc' => 'Competition history and season performance.'],
